...
:splashscreen
title Windows Manual Installer 0.1.3 - Stage %_stage%
cls
echo.
echo   ###           Windows Manual Installer BIOS version 0.1.3           ###
...
echo   ###   I'm not the responsible for any damage that may be caused to  ###
...
goto :end_stage1
	...
	echo        ###  privacy settings. After that, you're good to go^! You will have  ###
	echo        ###  to start WMI another time by typing "c:\wmi" on the CMD prompt  ###
	echo        ###  to clean the environment and to show the Credits screen.        ###     
	echo        ###                                                                  ###
...
title Windows Manual Installer 0.1.3 - End
echo Done.
cls
echo.
echo        ###                                                                  ###
