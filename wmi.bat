...
::"%mypath:~0,-1\"
title Windows Manual Installer 0.1.4 UEFI Edition - Stage %_stage%
cls
echo.
echo    *************************************
...
title Windows Manual Installer 0.1.4 UEFI Edition - End
echo Done.
cls
echo.
echo           ********************************************************************
...
echo           *                                                                  *
echo           *                                                                  *
echo           *  Windows Manual Installer version 0.1.4 for UEFI systems         *
echo           *  Developed by ^<franzageek^>                                       *
echo           *                                                                  *
