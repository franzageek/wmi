...
echo.
echo                                    ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»   ÉÍÍÍÍÍÍ»   
echo                                    º                 º   º      º
echo                                    º   ÉÍÍÍÍÍÍÍÍÍ»   º   ÈÍÍ»   º      
echo                                    º   º         º   º      º   º
echo                                    º   º         º   º      º   º    
echo                                    º   º         º   ÈÍÍÍÍÍÍ¼   º 
echo                                    º   º         º              º
echo                                    ÈÍÍÍ¼         ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼
echo.
echo                                             FranzaGeek
echo ____________________________________________________________________________________________________
...
echo.
echo        Including WMI Rollback 0.1.0
echo.
...
echo   ################################ WMI Rollback version 0.1.0 ####################################
echo   ###                                                                                          ###
...
if "%problem%"=="adnf" goto :adnf
	...
	(echo select disk %destdisk% &echo sel par 1 &echo format fs=ntfs) | diskpart 
	echo.
